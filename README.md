...
> **Versão:** 1.91.0 · **Autor:** Fabricio Souza (github.com/fabriciopsouza/metacognition-framework-premium) · **Base:** pesquisas A0–A3 · **PT-BR** · **CC BY 4.0** (ver [`LICENSE`](LICENSE) · [`NOTICE`](NOTICE))

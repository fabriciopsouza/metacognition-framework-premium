...
def main():
    fails = []
    SSH = "git@github.com:fabriciopsouza/metacognition-framework-premium.git"
    HTTPS = "https://github.com/fabriciopsouza/metacognition-framework-premium"
    ...
    if _norm_remote(SSH) != "github.com/fabriciopsouza/metacognition-framework-premium":

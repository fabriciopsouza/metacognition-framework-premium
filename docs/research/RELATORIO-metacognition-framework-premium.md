...
>
> **Fonte primária.** Repositório `github.com/fabriciopsouza/metacognition-framework-premium-premium` (branch `main`), lido via `raw.githubusercontent.com` em 01/06/2026. Versão declarada no `README.md`: **1.35.0**. Licença: **CC BY 4.0**. Idioma do framework: **PT-BR**. Autor declarado: Fabricio Souza.
>
